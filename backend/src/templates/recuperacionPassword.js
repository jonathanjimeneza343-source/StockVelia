                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                    <tbody>
                     <tr>
                      <td align="center" style="padding:10px 0;Margin:0;font-size:0px"><img src="https://fazootd.stripocdn.email/content/guids/CABINET_990a1e322203296415bd85334475a2ed7dacbec58a0c8d7b81e3df3c7e85864e/images/logo_stockvelia.png" alt="" width="118" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></td>
                     </tr>
                     <tr>
                      <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding:15px 40px"><h2 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333">Recuperación de contraseña</h2></td>
                     </tr>
                     <tr>
                      <td align="left" style="padding:10px 0 0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;font-weight:normal;color:#333333;font-size:14px">Hemos recibido una solicitud para restablecer la contraseña de tu cuenta en StockVelia. Utiliza el siguiente código de verificación para continuar:</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px;letter-spacing:0;font-weight:normal;color:#333333;font-size:14px"><br></p></td>
                     </tr>
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:36px;letter-spacing:0;font-weight:bold;color:black;font-size:24px;max-width:400px;background-color:white;border-radius:8px;box-shadow:0px 4px 8px #0000001A;text-align:center;margin:0 auto;padding:20px">${codigo}</p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;border-radius:5px;border-collapse:separate" role="presentation">
                    <tbody>
                     <tr>
                      <td align="center" style="padding:10px 0 0;Margin:0"><h3 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:30px;color:#333333"><br></h3><h3 class="es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:30px;color:#333333">Este código es válido por 15 minutos.</h3></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:10px 0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;font-weight:normal;color:#333333;font-size:14px">Si no solicitaste este cambio, puedes ignorar este mensaje. Tu cuenta permanecerá segura.</p></td>
                     </tr>
                    </tbody>
                   </table></td>
                 </tr>
                     ...
                     <tr>
                      <td align="center" style="padding:15px 0;Margin:0;font-size:0">
                       <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                        <tbody>
                         <tr>
                          <td align="center" valign="top" style="padding:0 40px 0 0;Margin:0"><img title="Facebook" src="https://fazootd.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></td>
                          <td valign="top" align="center" style="padding:0 40px 0 0;Margin:0"><img alt="Tw" width="32" title="Twitter" src="https://fazootd.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></td>
                          <td align="center" valign="top" style="padding:0 40px 0 0;Margin:0"><img width="32" title="Instagram" src="https://fazootd.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></td>
                          <td align="center" valign="top" style="padding:0;Margin:0"><img width="32" title="Youtube" src="https://fazootd.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none;margin:0"></td>
                         </tr>
                        </tbody>
                       </table></td>
                     </tr>
